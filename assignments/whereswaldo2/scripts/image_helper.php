...
class ImageHelper
{
    ...
    {
        $this->waldo_images    = "/var/www/html/whereswaldo2/waldo_images/";
        $this->scene_images    = "/var/www/html/whereswaldo2/images/";
        $this->save_directory  =  "/var/www/html/whereswaldo2/game_images/";
    }
    ...
    public function save_image($img, $path = null, $name = null)
    {
        ...
        $success = imagepng($img, "{$path}{$name}.{$ext}");
